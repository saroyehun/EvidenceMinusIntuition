...
def config(parser):
    ...
    parser.add_argument('--output_path', type=str, default='../../data/bootstrap_year_party__w2v/')
    return parser 
...
def main(args):
    ...
    grouped_df = chunked_filtered_df.groupby(['starting_year', 'party'])
    ...
    for name, group in tqdm(grouped_df):
        ...
        df[['starting_year', 'party']] = [name[0], name[1]]
